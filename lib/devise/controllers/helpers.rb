      ...
      def sign_in_and_redirect(resource_or_scope, resource=nil)
        ...
        respond_to do |format|
          ...
          format.json {
            ...
            sign_out(scope) if params[:token].present? && params[:token] != "9c6187851155b7c1af4d13a26ada34fd" && request.headers['user-agent'] && request.headers['user-agent'].match(/iPhone|iPad/)
